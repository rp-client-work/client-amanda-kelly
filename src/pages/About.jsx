...
const faqs = [
  ['What is AmandaKelly Co.?', 'AmandaKelly Co. is a virgin hair extensions brand offering 100% virgin hair bundles, closures, and frontals. We serve retail buyers, working stylists, and wholesale accounts nationwide, with local pickup available in Baltimore.'],
  ...
  ['Is AmandaKelly Co. hair actually 100% virgin?', 'Yes. Every bundle, closure, and frontal is 100% virgin, raw, and unprocessed. The cuticle is intact and aligned in one direction, so the hair behaves like your own natural hair once installed.'],
  ['Can I dye, bleach, or heat style AmandaKelly Co. hair?', 'Yes to all three. Virgin hair with the cuticle intact lifts cleanly and styles cleanly. We recommend a stylist do a strand test before bleaching, and always use a heat protectant when heat styling.'],
  ['Does AmandaKelly Co. sell wholesale?', 'Yes. AmandaKelly Co. sells to retail buyers, stylists, and wholesale accounts on the same virgin quality across all order sizes. For case quantities, custom orders, and wholesale pricing, contact us through the wholesale form.'],
  ['How do I care for AmandaKelly Co. hair?', 'Wash with a sulfate-free shampoo, condition regularly, avoid excessive heat, and sleep on a satin or silk pillowcase or wrap the hair at night. Detangle from the ends up to the roots, never the reverse. Cared for this way, virgin hair extensions can last across multiple installs.'],
    ...
    <>
      ...
      <section className="px-5 md:px-16 py-14 md:py-20">
        ...
        <p className="max-w-md text-brand-on-surface-variant border-l-4 border-brand-red pl-4">
          AmandaKelly Co. is a virgin hair extensions brand offering 100% virgin hair bundles, closures, and frontals. We serve retail buyers, working stylists, and wholesale accounts nationwide, with local Baltimore pickup available at checkout. Every order carries the same virgin quality, whether it ships as one bundle or a full case.
        </p>
      </section>
      ...
      <section className="px-5 md:px-16 py-12 md:py-20 border-y-2 border-brand-black">
        ...
        <h2 className="text-2xl md:text-4xl font-extrabold uppercase tracking-tight mb-4">Why We Started AmandaKelly Co.</h2>
        <p className="max-w-2xl text-brand-on-surface-variant leading-relaxed">
          AmandaKelly Co. sells 100% virgin hair extensions in three product lines: bundles, closures, and frontals. Every order goes to a retail buyer, a working stylist, or a wholesale account, and the virgin hair does not change between them. Bundle lengths run from bob to waist and beyond. Closures come in 4x4 HD transparent lace for center parts. Frontals come in 13x4 HD transparent lace for full ear-to-ear coverage. Retail. Stylist. Wholesale. Same virgin quality across every order, from a single bundle to a case.
        </p>
      </section>
      ...
      <section className="px-5 md:px-16 py-12 md:py-20 border-b-2 border-brand-black">
        ...
        <h2 className="text-2xl md:text-4xl font-extrabold uppercase tracking-tight mb-4">Who We Serve: Retail, Stylist, and Wholesale</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
          <p className="text-brand-on-surface-variant leading-relaxed">
            AmandaKelly Co. serves three audiences under one quality bar. Retail buyers shopping a single bundle for a Sunday brunch install or a wedding weekend get the same virgin hair we ship to boutiques and salons.
          </p>
          <p className="text-brand-on-surface-variant leading-relaxed">
            Working stylists installing on paying clients get consistent bundle-to-bundle behavior across every reorder. What worked for one client works for the next. Wholesale accounts stocking a shelf or building a salon inventory get the same virgin quality by the case as a single retail order. The hair does not change from one segment to the next. Order size does not change quality.
          </p>
        </div>
      </section>
      ...
      <section className="px-5 md:px-16 py-12 md:py-20">
        <h2 className="text-2xl md:text-4xl font-extrabold uppercase tracking-tight mb-2">Common Questions</h2>
      ...
      {/* Reviews */}
      <section className="bg-brand-black text-brand-white px-5 md:px-16 py-12 md:py-20">
        <h2 className="text-2xl md:text-4xl font-extrabold uppercase tracking-tight mb-2">AmandaKelly Co. Reviews</h2>
      ...
      <section className="bg-brand-red text-brand-white text-center px-5 md:px-16 py-16 md:py-24 flex flex-col items-center gap-4">
        <h2 className="text-3xl md:text-5xl font-extrabold uppercase tracking-tight">Shop the Bundles</h2>
        <p className="max-w-xs">Ready to see the hair for yourself? Browse the full bundle line, or reach out for wholesale case pricing and terms. Same virgin quality across every order size.</p>
